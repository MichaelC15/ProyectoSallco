<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cliente.aspx.cs" Inherits="ClienteWSProyecto.Cliente" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="form-control">
                        ...
                        <asp:TextBox ID="txtidCliente" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="table-container">
            <table id="tablaClientes" class="table table-bordered" style="width: 100%">
                <thead>
                    <tr>
                        <th>ID Cliente</th>
                        <th>Nombre</th>
                ...
                <tbody>
                    <asp:PlaceHolder ID="phTablaClientes" runat="server"></asp:PlaceHolder>
                </tbody>
            </table>
        </div>
    </form>
