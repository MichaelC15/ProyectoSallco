<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Producto.aspx.cs" Inherits="ClienteWSProyecto.Producto" %>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="form-control">
                        ...
                        <asp:TextBox ID="txtidProducto" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvidProducto" runat="server" ControlToValidate="txtidProducto"
                            ErrorMessage="Debe ingresar ID del Producto" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="form-control">
                        ...
                        <asp:TextBox ID="txtPrecio" runat="server" CssClass="form-control" Enabled="false" Width="100%"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-control">
                        ...
                        <asp:TextBox ID="txtStock" runat="server" CssClass="form-control" Enabled="false" Width="100%"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    <label for="txtUbicacionID" class="form-label">Ubicación ID:</label>
                    <div class="form-control">
                        <i class="fas fa-map-marker-alt"></i>
                        <asp:TextBox ID="txtUbicacionID" runat="server" CssClass="form-control" Enabled="false" Width="100%"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="mb-3">
