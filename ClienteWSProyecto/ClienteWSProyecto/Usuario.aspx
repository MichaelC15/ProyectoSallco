<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Usuario.aspx.cs" Inherits="ClienteWSProyecto.Usuario" %>
    ...
    <form id="form1" runat="server">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="form-control">
                        ...
                        <asp:TextBox ID="txtidUsuario" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvidUsuario" runat="server" ControlToValidate="txtidUsuario"
                            ErrorMessage="Debe ingresar ID del Usuario" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                    <label for="txtRol_id" class="form-label">Rol ID:</label>
                    <div class="form-control">
                        <i class="fas fa-user-tag"></i>
                        <asp:TextBox ID="txtRol_id" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="form-control">
                        ...
                        <asp:TextBox ID="txtContraseña" runat="server" CssClass="form-control" Enabled="false" Width="100%"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-control">
                        <i class="fas fa-user"></i>
                        <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control" Enabled="false" Width="100%"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-control">
                        <i class="fas fa-user"></i>
                        <asp:TextBox ID="txtApellido" runat="server" CssClass="form-control" Enabled="false" Width="100%"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-control">
                        ...
                        <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" Enabled="false" Width="100%"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="mb-3">
        ...
        <div class="table-container">
            <table id="tablaUsuarios" class="table table-bordered" style="width: 100%">
                ...
                <tbody>
                    <asp:PlaceHolder ID="phTablaUsuarios" runat="server"></asp:PlaceHolder>
                </tbody>
            </table>
        </div>
    </form>
